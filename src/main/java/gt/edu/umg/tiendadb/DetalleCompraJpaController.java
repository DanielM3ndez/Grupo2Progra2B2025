...
public class DetalleCompraJpaController implements Serializable {
    ...
    public void create(DetalleCompra detalleCompra) {
        ...
        try {
            ...
            if (idProducto != null) {
                idProducto.getDetalleCompraCollection().add(detalleCompra);
    ...
    public void edit(DetalleCompra detalleCompra) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            if (idProductoOld != null && !idProductoOld.equals(idProductoNew)) {
                idProductoOld.getDetalleCompraCollection().remove(detalleCompra);
                idProductoOld = em.merge(idProductoOld);
            }
            if (idProductoNew != null && !idProductoNew.equals(idProductoOld)) {
                idProductoNew.getDetalleCompraCollection().add(detalleCompra);
    ...
    public void destroy(Integer id) throws NonexistentEntityException {
        ...
        try {
            ...
            Producto idProducto = detalleCompra.getIdProducto();
            if (idProducto != null) {
                idProducto.getDetalleCompraCollection().remove(detalleCompra);
                idProducto = em.merge(idProducto);
            }
